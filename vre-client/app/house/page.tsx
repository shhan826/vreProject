...
import SkeletonHouseMain from "@/component/skeletonHouseMain";
                ...
                <main className="mt-13 mb-19 mx-auto xl:max-w-6xl lg:max-w-4xl">
                    <div className="pt-8 px-4">
                        ...
                        <div className="pt-3 pb-6 border-gray-100 border-t-1">
                            ...
                            <HouseInfoRow subject={'Floors'} content={houseItem.number_floors}/>
                            <HouseInfoRow subject={'Room count'} content={houseItem.room_count}/>
                            <HouseInfoRow subject={'Bathroom'} content={houseItem.bathroom_count}/>
